    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>FactCLN</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="fa fa-circle" style="color: rgba(0,193,63,255);"></span>

                  <span class="hidden-xs">Yefry Moraga</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      7721-6123(M); 5766-4620 (Cl)
                      <small>jeffamed@gmail.com</small>
                    </p>
                  </li>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="{{Auth::logout()}}" class="btn btn-default btn-flat"><span class="fa fa-sign-out"></span> Cerrar</a>
                    </div>
                  </li>
                </ul>
              </li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema de Facturación</h3>
